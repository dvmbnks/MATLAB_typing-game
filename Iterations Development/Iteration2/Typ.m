% Version 1, with GUI provided by MATLAB GUIDE.  
...
% Last Modified by GUIDE v2.5 16-Apr-2023 16:32:48
...
% Collect input. 
inputText = get(handles.input1,'string');
...
% Display vector in GUI. 
set(handles.displaytext, 'string',word);


% --- Executes on button press in pushbutton2.
function pushbutton2_Callback(~, ~, handles)
% Timer Function provided by Matlab. [Check bibliography]
t = timer('TimerFcn', 'stat=false; disp(''END!!!!'')','StartDelay',60);
% Starting timer. 
start(t)
